        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="w-16 h-1 bg-blue-900 mb-6"></div> {/* Changed to blue-900 */}
              ...
              {images.map((img, index) => (
                <div
                  ...
                  className={`relative w-24 h-24 rounded-lg overflow-hidden cursor-pointer border-2 transition-all ${
                    currentImage.src === img.src ? "border-blue-900 shadow-md" : "border-gray-200 hover:border-blue-300"
                  }`}
